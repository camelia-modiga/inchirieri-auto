...
EXECUTE CLIENTI_PACK.ADD_CLIENTI('BV183916','CI','Popescu','Matei','popescumatei@yahoo.com','0786903009',to_date('10.03.2010','DD.MM.YYYY'),to_date('13.09.1973','DD.MM.YYYY'));
EXECUTE CLIENTI_PACK.ADD_CLIENTI('MX129056','CI','Pavel','Maria','maria.pavel@gmail.com','0750976725',to_date('01.03.2016','DD.MM.YYYY'),to_date('08.02.1990','DD.MM.YYYY'));
EXECUTE CLIENTI_PACK.ADD_CLIENTI('MX456009','CI','Marinescu','Ioana','marinescu_io03@yahoo.com','0786762900',to_date('10.01.2018','DD.MM.YYYY'),to_date('10.09.1995','DD.MM.YYYY'));
EXECUTE CLIENTI_PACK.ADD_CLIENTI('TM889012','CI','Cristea','Alexandru','alex_crst9@gmail.com','0728900156',to_date('17.08.2017','DD.MM.YYYY'),to_date('15.10.1991','DD.MM.YYYY'));
EXECUTE CLIENTI_PACK.ADD_CLIENTI('040000314','Pasaport','Alexandrescu','Cristina','cristinaaalx@gmail.com','0759007689',to_date('19.01.2019','DD.MM.YYYY'),to_date('12.12.1998','DD.MM.YYYY'));
EXECUTE CLIENTI_PACK.ADD_CLIENTI('BV871245','CI','Ionescu','George','george078@gmail.com','0783009851',to_date('20.05.2019','DD.MM.YYYY'),to_date('12.05.1998','DD.MM.YYYY'));
EXECUTE CLIENTI_PACK.ADD_CLIENTI('MX651490','CI','Enachi','Anca',null,'0732751200',to_date('12.07.2016','DD.MM.YYYY'),to_date('24.12.1988','DD.MM.YYYY'));
EXECUTE CLIENTI_PACK.ADD_CLIENTI('183916987','Pasaport','Thompson','Sandra','sandra_th@gmail.com','0786502635',to_date('10.03.2014','DD.MM.YYYY'),to_date('10.06.1980','DD.MM.YYYY'));
EXECUTE CLIENTI_PACK.ADD_CLIENTI('861082569','Pasaport','Gomez','Allison','gomez_allison@yahoo.com','0787114907',to_date('12.12.2016','DD.MM.YYYY'),to_date('12.12.1980','DD.MM.YYYY'));
EXECUTE CLIENTI_PACK.ADD_CLIENTI('XC783916','CI','Popa','Andrei','popa1234@yahoo.com','0786903012',to_date('11.10.2015','DD.MM.YYYY'),to_date('13.09.1985','DD.MM.YYYY'));
EXECUTE CLIENTI_PACK.ADD_CLIENTI('MX183916','CI','Grecu','Marius','grecu.mar@yahoo.com','0736913009',to_date('10.03.2019','DD.MM.YYYY'),to_date('13.09.1990','DD.MM.YYYY'));
EXECUTE CLIENTI_PACK.ADD_CLIENTI('MX183016','CI','Vasiliu','Daniela','dana_vasiliu@gmail.com','0745903349',to_date('03.03.2013','DD.MM.YYYY'),to_date('23.12.1990','DD.MM.YYYY'));
EXECUTE CLIENTI_PACK.ADD_CLIENTI('MZ183916','CI','Morosanu','Dan','dan78_moro@gmail.com','0722345799',to_date('06.06.2016','DD.MM.YYYY'),to_date('24.10.1991','DD.MM.YYYY'));
EXECUTE CLIENTI_PACK.ADD_CLIENTI('8614989028','Pasaport','Anton','Teodora','teo1234@yahoo.com','0755098123',to_date('12.05.2016','DD.MM.YYYY'),to_date('21.08.1991','DD.MM.YYYY'));
EXECUTE CLIENTI_PACK.ADD_CLIENTI('977261182','Pasaport','Georgescu','Marian','georgescu@yahoo.com','0786998109',to_date('14.10.2016','DD.MM.YYYY'),to_date('22.08.1993','DD.MM.YYYY'));
EXECUTE CLIENTI_PACK.ADD_CLIENTI('VS187255','CI','Hanganu','Alice','alicehng@yahoo.com','0786876510',to_date('14.12.2018','DD.MM.YYYY'),to_date('13.09.1997','DD.MM.YYYY'));
EXECUTE CLIENTI_PACK.ADD_CLIENTI('BV123887','CI','Iacob','Sebastian','sebi_iacob@yahoo.com','0755198667',to_date('15.10.2018','DD.MM.YYYY'),to_date('13.09.1996','DD.MM.YYYY'));
EXECUTE CLIENTI_PACK.ADD_CLIENTI('XC986120','CI','Iosub','Luca',null,'0721900817',to_date('10.03.2018','DD.MM.YYYY'),to_date('23.09.1996','DD.MM.YYYY'));
